...
//решение 2 через массив строк

string[] quarters = {"x>0 && y>0", "x>0 && y<0", "x<0 && y<0", "x<0 && y>0"};
Console.Write("введите четверть для вывода диапозона возможных координат точек ");
...
{
    Console.WriteLine("дипозон четверти задан не верный, напишите цифру от 1 до 4х");
}